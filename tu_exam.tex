...
\coverfirstpageheader{Taif University \\ Department of Mathematics \\ \& Statistics}{\includegraphics[scale=0.4]{logo1.jpg}}{Numerical Methods \\ Final Exam \\ Time: 3 Hours}
\runningheadrule
\runningfootrule
\onehalfspacing
\newcommand{\tf}[1][{}]{%
...
\begin{questions}
\uplevel{Answer the following questions.}

\question[5] $\sin^2(x) + \cos^2(x) = $ \\
  \begin{oneparchoices}
\choice $\displaystyle -1$
\CorrectChoice $\displaystyle 1$
\choice $\displaystyle 0$
\choice $\displaystyle \tan(x)$
\end{oneparchoices}

\question This is a multiple parts question
\begin{parts}
